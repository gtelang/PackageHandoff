...
- @@html:<font color = "blue">@@ Package input mode @@html:</font>@@ ::
  0. To enter press *p* and show this on the screenr
...
- ProbX.hs ::  Implementation of the arrows *Render World*, *Step World*, *Handle Events*, and algorithms, 
...
the code more modular. Besides, it is possible that using javascript libraries via GHCJS might 
